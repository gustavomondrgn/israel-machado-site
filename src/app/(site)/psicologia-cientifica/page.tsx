...
export default async function PsicologiaCientifica() {
  const artigos = await getPublishedArtigos();
      ...
      <section className="relative py-20 lg:py-28 bg-ivory">
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            {artigos.length === 0 ? (
              <FadeIn delay={0.1}>
                <div className="bg-cream border border-border/60 rounded-sm p-7 lg:p-8 text-center">
              ...
              <div className="space-y-6">
                {artigos.map((artigo, i) => (
                  <FadeIn key={String(artigo.id)} delay={0.1 + i * 0.05}>
                    <div className="bg-cream border border-border/60 rounded-sm p-7 lg:p-8 shadow-sm hover:shadow-md hover:border-bronze/40 transition-all duration-300 group">
                      <Link href={`/psicologia-cientifica/${artigo.slug}`} className="block">
