...
function HeroSection() {
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-[92vh] hidden lg:block">
          <img
            src={PERFIL_EXTENDED}
          ...
          <div className="relative z-10 h-full min-h-[92vh] flex items-center pt-28 pb-12">
            ...
            <FadeIn delay={0.3}>
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  "Know Thyself — The Value and Limits of Self-Knowledge: The Unconscious (The University of Edinburgh) — em andamento",
                ].map((item, i) => (
