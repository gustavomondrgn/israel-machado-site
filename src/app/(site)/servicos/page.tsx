...
import { ArrowLeft, Phone, Users, Mic, MapPin, Monitor, ChevronLeft, ChevronRight } from "lucide-react";
...
const palestraImages = [
  { src: PALESTRA_FRENTE, alt: "Palestra sobre saúde mental" },
  { src: "/images/palestra-2.webp", alt: "Palestra — momento 2" },
  { src: "/images/palestra-3.webp", alt: "Palestra — momento 3" },
];

function PalestraCard() {
  const [current, setCurrent] = useState(0);

  useEffect(() => {
    const timer = setInterval(() => {
      setCurrent((c) => (c === palestraImages.length - 1 ? 0 : c + 1));
    }, 5000);
    return () => clearInterval(timer);
  }, []);

  const prev = () => setCurrent((c) => (c === 0 ? palestraImages.length - 1 : c - 1));
  const next = () => setCurrent((c) => (c === palestraImages.length - 1 ? 0 : c + 1));

  return (
    <div className="bg-ivory border border-border/30 rounded-sm overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-3">
        <div className="relative aspect-[16/9] lg:aspect-auto overflow-hidden group">
          {palestraImages.map((img, i) => (
            <img
              key={i}
              src={img.src}
              alt={img.alt}
              ...
              <div className="bg-cream border border-border/50 rounded-sm overflow-hidden shadow-sm">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="relative aspect-square lg:aspect-auto overflow-hidden">
                    <img
                      src="/images/psicoterapia-presencial-card.png"
                  ...
                  <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
                    ...
                    <ul className="space-y-2 mb-6">
                      <li className="flex items-start gap-2 font-sans text-sm text-foreground/65">
                        ...
                        Duração: entre 50 minutos e uma hora por sessão
                      </li>
                      <li className="flex items-start gap-2 font-sans text-sm text-foreground/65">
                        <span className="w-1.5 h-1.5 rounded-full bg-bronze mt-1.5 flex-shrink-0" />
                        Frequência: de uma ou mais vezes por semana
                      </li>
                      <li className="flex items-start gap-2 font-sans text-sm text-foreground/65">
                        <span className="w-1.5 h-1.5 rounded-full bg-bronze mt-1.5 flex-shrink-0" />
            ...
            <FadeIn delay={0.15}>
              <div className="bg-cream border border-border/50 rounded-sm overflow-hidden shadow-sm">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="relative aspect-square lg:aspect-auto overflow-hidden">
                    <img
                      src="/images/psicoterapia-social-card.png"
                  ...
                  <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
                    <div className="flex items-center gap-3 mb-3">
                      <Users className="w-5 h-5 text-marsala" />
                      <h2 className="font-display text-[20px] sm:text-[26px] font-semibold text-foreground">
                        Psicoterapia Presencial &mdash; Valor Social
                      </h2>
                    </div>
                    <p className="font-body text-base text-foreground/80 leading-[1.8] mb-5">
                      Psicoterapia individual de orientação psicanalítica.
                    ...
                    <ul className="space-y-2 mb-6">
                      ...
                      <li className="flex items-start gap-2 font-sans text-sm text-foreground/65">
                        <span className="w-1.5 h-1.5 rounded-full bg-bronze mt-1.5 flex-shrink-0" />
                        Dias e horários: Segundas das 8h às 12h &middot; Quartas das 13h30 às 17h30
                      </li>
                      <li className="flex items-start gap-2 font-sans text-sm text-foreground/65">
                        <span className="w-1.5 h-1.5 rounded-full bg-bronze mt-1.5 flex-shrink-0" />
                        Público: adultos
              ...
              <FadeIn delay={0.1} className="lg:col-span-2">
                ...
                >
                  <div className="relative aspect-[16/10] overflow-hidden">
                    <img
                      src="/images/clinical-center-img-2.jpg"
                  ...
                  <div className="p-7">
                    ...
                    <div className="flex items-start gap-2 mb-3">
                      ...
                      <p className="font-sans text-sm text-foreground/70">
                        Rua Uruguai, 1969 &mdash; Passo Fundo, RS
                      </p>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <p className="font-sans text-xs text-foreground/65">
                        Pça. Mal. Floriano &mdash; Passo Fundo, RS
                      </p>
                    </div>
