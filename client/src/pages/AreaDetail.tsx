    ...
    return (
      <Layout>
        <div className="pt-32 pb-20 container text-center">
          <h1 className="font-display text-3xl text-foreground mb-4">Conteúdo não encontrado</h1>
          <Link href="/#areas" className="font-sans text-sm text-marsala hover:underline">
            Voltar às áreas de atendimento
          </Link>
        </div>
      </Layout>
    );
